...
void LinkedList::Append(Bid bid) {
    // FIXED (2): Implemented append logic
    //Create new node
...
void LinkedList::Prepend(Bid bid) {
    // FIXED (3): Implemented prepend logic
    // Create new node
    Node* newNode = new Node(bid);
...
void LinkedList::PrintList() {
    // FIXED (4): Implemented print logic
    // start at the head
    Node* current = head;
...
void LinkedList::Remove(string bidId) {
    // FIXED (5): Implemented remove logic
    ...
    if (head->bid.bidId == bidId) {
        ...
        //decrease size count
        size -= 1;
        // added statement to notify of bid removed
    ...
    //added bid not found statement
    cout << "Bid not removed - Bid " << bidId << " not found." << endl;
}
...
Bid LinkedList::Search(string bidId) {
    // FIXED (6): Implemented search logic
